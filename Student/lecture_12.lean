...
-/
def eval_bin_bimp : Bool → Bool → Bool
| true, true => true
| false, false => true
| _, _ => false
...
| (Expr.un_exp op e),      i => (eval_un_op op) (eval_expr e i)
| (Expr.bin_exp op e1 e2), i => (eval_bin_op op) (eval_expr e1 i) (eval_expr e2 i)
| (Expr.bimp e1 e2),       i => eval_bin_bimp (eval_expr e1 i) (eval_expr e2 i)
...
def new_interpretation : Interp :=
  λ v,
    ...
    | 2 => tt -- jam
    | 3 => ff -- α
    | _ => tt -- for any other variable, we assign true
