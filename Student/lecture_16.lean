...
-- In prop all proofs are equivilent
-- Choice of value in Prop can't influence computation
...
-- Not P is to defined to be P

example : ¬ Chaos := λ (c : Chaos ) => nomatch c
